 ...
 * 违行
 */
app.controller('bikeViolationController', ['$rootScope', '$scope', 'toaster', '$interval', function ($rootScope, $scope, toaster, $interval) {
  ...
  // 图表数据源
  $scope.bikeParkDatas = [
    // {"id": id, "bikeId": "单车id",     "operator": "运营方", "userName": "违行人", 　"idCardNum": "违行人身份证号",             "userPhoneNum": "违行人手机号",    "time": "违行时间",          　　"userRespond": "违行人响应情况", "userFine": "违行人罚款", "opName": "运营方摆渡人", "opPhoneNum": "运营方手机号", "opRespond": "运营方响应情况", "opFine": "运营方罚款", "policeRespond": "警力处理响应情况", "dealResult": "处理结果",  "lat": 违行地点纬度, "lon": 违行地点纬度, "position": "违行地点"},
    {
      "id": 1,
      "bikeId": "0551115364",
      "operator": "A公司",
  ...
  function addOverlays(params) {
    ...
    var label2 = new BMap.Label('违行人: ' + singleBike.userPhoneNum, {offset: new BMap.Size(0, 32)});
    label2.setStyle(styles);
    $rootScope.backMarker.setLabel(label2);

    var label3 = new BMap.Label('违行地点: ' + singleBike.position, {offset: new BMap.Size(0, 59)});
  ...
  function showGrid() {
    $scope.gridOptions = {
      ...
      columnDefs: [
        {field: 'bikeId', displayName: '单车编号', width: '10%'},
        {field: 'operator', displayName: '运营方', width: '10%'},
        {field: 'userName', displayName: '违行人', width: '10%'},
        {field: 'violation', displayName: '违行行为', width: '10%'},
        {field: 'idCardNum', displayName: '违行人身份证号', width: '10%'},
        {field: 'userPhoneNum', displayName: '违行人手机号', width: '10%'},
        {field: 'time', displayName: '违行时间', width: '10%', cellTemplate: '<div class="ngCellText ng-scope" >{{row.entity.time| date:"yyyy-MM-dd hh:mm:ss"}}</div>'},
        {field: 'userRespond', displayName: '违行人响应情况', width: '10%'},
        {field: 'userFine', displayName: '违行人罚款', width: '10%'},
        {field: 'policeRespond', displayName: '警方响应情况', width: '10%'},
        {field: 'dealResult', displayName: '警方处理结果', width: '10%'}
      ]
    };
  }
  //------------------------- grid end ------------------------------//

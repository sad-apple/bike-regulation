...
app.controller('carIllegalMoving', ['$scope', '$interval', function ($scope, $interval) {

  var orgName = ["A公司", "B公司", "C公司", "D公司"];

  var areaName = {
    '蜀山区': ['梅山路 安徽中医药大学', '武警总队医院', '铜锣湾广场', '安徽省博物馆', '荷叶地', '肥西三河古镇', '琥珀山庄', '西园新村', '正在移动'],
    '瑶海区': ['生态公园', '中绿广场', '花冲公园', '长临古街', '瑶海公园', '岱山湖', '安徽中医药大学少泉湖校区', '拓基广场', '七里塘', '正在移动'],
    '包河区': ['包公园', '赤阑桥', '清风阁', '合肥明珠广场',  '孝肃桥', '欢乐岛', '斛兵塘', '徽园', '巢湖紫微洞','正在移动'],
    '滨湖区': ['塘西河公园', '金斗公园', '滨湖世纪城', '合肥市滨湖医院', '天山大厦','九联圩', '合肥万达乐园', '岸上草原', '万达大鼓', '正在移动'],
    '政务区': ['万达广成', '华邦世贸城', '国际丽晶城', '翠庭园', '紫兰苑', '天鹅湖畔', '绿地内森庄园', '兴园小区', '景尚明群', '正在移动'],
    '庐阳区': ['月潭庵', '古教弩台', '官亭林海', '庐阳环城公园', '百花大厦', '百花井', '逍遥津公园', '庐州灯火','巢湖紫微洞', '庐阳杏花公园', '正在移动']
  };
  ...
  function getDetails() {
    ...
    var details ={};
    details.plantNumber = plantNum[parseInt(Math.random() * plantNum.length)] + getRandomNum(5);
  ...
  // 初始化移动结束路线数据
  var endLineRoute = [
    {startX: 117.318698, startY: 31.845599, endX: 117.300362, endY: 31.834461},
    {startX: 117.328533, startY: 31.872861, endX: 117.319783, endY: 31.866658}
  ];


  // 初始化正在移动路线数据
  var movingLineRoute = [
    {startX: 117.238009, startY: 31.870647, endX: 117.249835, endY: 31.878414},
    {startX: 117.27621, startY: 31.854819, endX: 117.285828, endY: 31.847585}
  ];
  ...
  var yellowBike = new BMap.Icon("img/yellowcar.gif", new BMap.Size(70, 70), { // 黄色移动单车图标
  ...
  var redBike = new BMap.Icon("img/redcar.png", new BMap.Size(70, 70), { // 红色移动结束单车图标
    imageSize: new BMap.Size(50, 50),
    imageOffset: new BMap.Size(10, 10)
  });
